...
$total_query = mysqli_query($koneksi, "SELECT COUNT(*) as total FROM foto WHERE user_id='$user_id'");
...
$sql = mysqli_query($koneksi, "SELECT foto.*, album.nama_album FROM foto 
                                ...
                                WHERE foto.user_id='$user_id' LIMIT $limit OFFSET $offset");
                            ...
                            <tbody>
                                ...
                                while ($data = mysqli_fetch_array($sql)) {
                                    ...
                                    <tr>
                                        ...
                                        <td><img src="../assets/img/<?php echo $data['lokasi_file']; ?>" alt="" width="100px"></td>
                                        <td>

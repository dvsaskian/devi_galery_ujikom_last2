...
$start_album = ($page - 1) * $album_per_page; 

$foto_per_page = 8;
$page = isset($_GET['page']) ? (int)$_GET['page'] : 1;
$start = ($page - 1) * $foto_per_page; 

$total_foto_query = mysqli_query($koneksi, "SELECT COUNT(*) as total FROM album");
...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
    ...
    <div class="container mt-3 mb-5">
        ...
        <div class="row">
            ...
            <?php
            $devi_query_foto = mysqli_query($koneksi, "SELECT * FROM foto WHERE user_id='$user_id'");
